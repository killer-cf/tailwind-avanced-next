...
export function Trigger() {
  return (
    <label
      htmlFor="photo"
      className="hover:bg-violet-25 group flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-4 py-4 text-center text-zinc-500 shadow-sm hover:border-violet-200 hover:text-violet-500"
    >
